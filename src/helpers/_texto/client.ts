import { Client as KREChainClient } from 'kREChain';
import { publicKeyCreate } from 'secp256k1';
import { getDeviceMessageHashToSign, getDeviceAddress } from '@oREChain/ocore/object_hash';
...
export default class Client {
  ...
  constructor(config) {
    ...
    this.client = config.client ? config.client : new KREChainClient(this.address);
    this.config = config;
